...
# Declare constants
dirToUpdate="/data/finnes"
gitRepoAddress="git@github.com:esfinn/FelixScripts.git" # ssh version of remote address, copied from the webpage of your newly created github repo.
