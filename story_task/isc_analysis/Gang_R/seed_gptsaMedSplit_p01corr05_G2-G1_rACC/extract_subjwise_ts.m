...
for ss = 1:length(subj_list)
    tmp = importdata(['seed_gptsaMedSplit_p01corr05_Ave-G12_rAngGyr_',subj_list{ss},'_story_audioTRs.txt']);
    all_subj_ts(:,ss) = tmp;
end

save('seed_gptsaMedSplit_p01corr05_AveG12_rAngGyr_all_subj_ts.mat','all_subj_ts')
