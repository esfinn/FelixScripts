...
3dmaskave -quiet -mask rAngGyr_p005_mask_0001+tlrc.HEAD /data/finnes/story_task/${i}/${i}.StoryAll.volResults/errts.${i}.fanaticor+tlrc.HEAD > ${i}.StoryAll.volResults.txt
