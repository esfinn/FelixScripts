...
3dcalc -a aparc+aseg.nii -datum byte -prefix FT_vent.nii -expr 'amongst(a,4,43)'

# Select the WM maps from the FS output.
3dcalc -a aparc+aseg.nii -datum byte -prefix FT_WM.nii -expr 'amongst(a,2,7,41,46,251,252,253,254,255)'
