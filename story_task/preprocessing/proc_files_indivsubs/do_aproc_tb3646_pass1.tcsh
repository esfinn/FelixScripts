...
set top_dir   = /mri2data2/mri_group/emily_data/story_task/tb3646/

# set subject and group identifiers
set subj      = tb3646_pass1
set group_id  = hc
...
afni_proc.py -subj_id $subj                                                 \
	...
	-out_dir $top_dir/$subj.results                                    \
        ...
        -copy_anat $top_dir/tb3646_s003_constable_????????_stack3d_orig_shft.nii \
        -tcat_remove_first_trs 0                                            \
        -dsets                                                              \
            $top_dir/tb3646_s???_constable_????????_stack4d_orig_shft.nii        \
        -tlrc_base $ref_base                                    \
