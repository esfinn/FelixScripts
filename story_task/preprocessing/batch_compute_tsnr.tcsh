...
# get TSNR
3dTstat -tsnr -mask full_mask.${subj}_pass1+tlrc.HEAD -prefix tsnr_story_audio_TRs_errts.${subj}_pass1.fanaticor+tlrc.HEAD story_audioTRs_errts.${subj}_pass1.fanaticor+tlrc.HEAD
