...
clust2_all_subj_ts = zeros(2,1302,length(subj_list));

for ss = 1:length(subj_list)
    
filename = ['/data/finnes/story_task/isc_analysis/Gang_R/clusters_gptsaMedSplit_p01corr05_AveMinusG12/clusterts_n6_gptsaMedSplit_p01corr05_AveMinusG12_' subj_list{ss} '_story_audioTRs_000.netts'];
delimiter = '\t';
...
clust2_all_subj_ts(:,:,ss)= dataArray;
