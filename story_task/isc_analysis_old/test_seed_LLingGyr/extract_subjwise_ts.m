...
for ss = 1:length(subj_list)
    T = readtable(['LLingGyr_p0093_clust433_',subj_list{ss},'_story_audioTRs.txt']);
    all_subj_ts(:,ss) = T.Var1;
end
