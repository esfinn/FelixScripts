...
3dDeconvolve -input pb03.$subj.r*.blur+tlrc.HEAD                           \
    ...
    -stim_file 13 $topdir/feature_analysis/faceDetectManualOnsets_HRFconv.txt -stim_label 13 faceDetectManualOnsets \
    -fout -tout -x1D XplusfaceDetectManualOnsets.xmat.1D -xjpeg XplusfaceDetectManualOnsets.jpg                                \
    -x1D_uncensored XplusfaceDetectManualOnsets.nocensor.xmat.1D                                     \
    -fitts fitts.faceDetectManualOnsets.${subj}                                                     \
    -errts errts.faceDetectManualOnsets.${subj}                                                   \
    -bucket stats.faceDetectManualOnsets.${subj} \
    -jobs 12 
done
