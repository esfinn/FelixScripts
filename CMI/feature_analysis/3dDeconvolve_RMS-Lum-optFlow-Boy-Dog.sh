...
3dDeconvolve -input pb03.$subj.r*.blur+tlrc.HEAD                           \
    ...
    -stim_file 14 $topdir/feature_analysis/meanGrayLevels_HRFconvolved.txt -stim_label 14 meanGrayLevels \
    -stim_file 15 $topdir/feature_analysis/optFlow_HRFconv.txt -stim_label 15 optFlow \
    -stim_file 16 $topdir/feature_analysis/boyManual_HRFconv.txt -stim_label 16 boyManual \
    -stim_file 17 $topdir/feature_analysis/dogManual_HRFconv.txt -stim_label 17 dogManual \
