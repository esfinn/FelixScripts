...
afni_proc.py -subj_id $subj                                                 \
	...
	-out_dir /data/finnes/CMI/preprocessed_data/$task/$subj.$task.volResults                                    \
	...
	-anat_has_skull yes \
        ...
        -dsets /data/CMI/release_2/MRI/sub-NDARUW904FMQ/func/sub-${subj}_task-movieTP_bold.nii.gz        \
